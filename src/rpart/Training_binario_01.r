...
PARAM$semillas <- c(100019, 503143)
...
archivo_salida <- "./exp/HT2020/gridsearch_binario01.txt"
...
for (vcp in c(0.2, 0.3)) {
  for (vmax_depth in c(4, 6)) {
    for (vmin_split in c(500, 700)) {
      for (vmin_bucket in c(25, 50)) {
