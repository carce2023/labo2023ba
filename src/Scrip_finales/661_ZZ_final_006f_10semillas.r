...
PARAM <- list()
PARAM$experimento <- "ZZ661_006f_10semillas"
PARAM$exp_input <- "HT651_006f"
...
PARAM$semillas <- c(529927, 609503, 701639, 800237,200117, 200063, 300517, 300899, 701483, 800521)
